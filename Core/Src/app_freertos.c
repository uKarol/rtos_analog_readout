...
extern void StartTaskADC(void *argument);
extern void StartTaskCom(void *argument);
...
void MX_FREERTOS_Init(void) {
  ...
  ADC_queueHandle = osMessageQueueNew (100, sizeof(uint16_t), &ADC_queue_attributes);
  ...
  /* creation of TaskCom */
  TaskComHandle = osThreadNew(StartTaskCom, NULL, &TaskCom_attributes);
